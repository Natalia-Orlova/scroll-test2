var ScrollyVideo = (function () {
  ...
  (t = s),
    ...
    (function (i, s) {
      var r = "function",
        ...
        R = function (t, e) {
          return typeof t === o && -1 !== N(e).indexOf(N(t));
        },
        N = function (t) {
        ...
        M = function (t, e) {
          if (typeof t === o)
            return (
              ...
              typeof e === n ? t : t.substring(0, 255)
            );
        },
        O = function (t, e) {
          ...
          for (var i in e)
            if (typeof e[i] === a && e[i].length > 0) {
              for (var r = 0; r < e[i].length; r++)
                if (R(e[i][r], t)) return "?" === i ? s : i;
            } else if (R(e[i], t)) return "?" === i ? s : i;
          return t;
        },
        H = {
          ME: "4.90",
        ...
        Y = function (t, e) {
          if ((typeof t === a && ((e = t), (t = s)), !(this instanceof Y)))
          ...
          return (
            ...
            (this.getCPU = function () {
              var t = {};
              return (t.architecture = s), O.call(t, r, h.cpu), t;
            }),
            ...
            (this.getEngine = function () {
              var t = {};
              return (t.name = s), (t.version = s), O.call(t, r, h.engine), t;
            }),
            (this.getOS = function () {
              var t = {};
              return (t.name = s), (t.version = s), O.call(t, r, h.os), t;
            }),
            ...
            (this.setUA = function (t) {
              return (
                (r = typeof t === o && t.length > 255 ? M(t, 255) : t), this
              );
            }),
            this.setUA(r),
            this
      ...
      (Y.VERSION = "1.0.2"),
        (Y.BROWSER = D([d, f, "major"])),
        (Y.CPU = D([u])),
        (Y.DEVICE = D([h, p, l, c, m, g, _, y, b])),
        (Y.ENGINE = Y.OS = D([d, f])),
          ...
          for (e = 0; e < r.sample_sizes.length; e++) {
            ...
            (B.number = e),
              ...
              e > 0
                ...
                : (B.dts = 0),
              a
                ? (e >= v && (U++, v < 0 && (v = 0), (v += a.sample_counts[U])),
                ...
                for (
                  ...
                  for (i = 0; i < g.sample_count; i++) {
                    ...
                    var y = !!(p.tfhd.flags & l.TFHD_FLAG_BASE_DATA_OFFSET),
                      ...
                      w = !!(g.flags & l.TRUN_FLAGS_DATA_OFFSET),
                      v = 0;
                    (v = y
  ...
  return class {
    constructor({
      ...
      if (!t) throw new Error("Must provide valid video src to ScrollyVideo");
      ...
      (this.isSafari = "WebKit" === p.name),
        ...
        (this.updateScrollPercentage = () => {
          const t = this.container.parentNode.getBoundingClientRect(),
            e = -t.top / (t.height - window.innerHeight);
          this.debug && console.info("ScrollyVideo scrolled to", e),
            this.setTargetTimePercent(e);
        }),
        this.trackScroll &&
    ...
    setCoverStyle(t) {
      if (this.cover) {
        ...
        const { width: e, height: i } = this.container.getBoundingClientRect(),
          { width: s, height: r } = t.getBoundingClientRect();
    ...
    transitionToTargetTime() {
      ...
      const t = this.targetTime - this.currentTime;
      if (this.canvas)
        (this.currentTime += t / (256 / this.transitionSpeed)),
          this.paintCanvasFrame(Math.floor(this.currentTime * this.frameRate));
      else if (this.isSafari || this.targetTime - this.currentTime < 0)
        this.video.pause(),
          (this.currentTime += t / (64 / this.transitionSpeed)),
          (this.video.currentTime = this.currentTime);
      else {
        const e = Math.max(Math.min(4 * t, this.transitionSpeed, 16), 1);
        this.debug && console.info("ScrollyVideo playbackRate:", e),
          isNaN(e) || ((this.video.playbackRate = e), this.video.play()),
          (this.currentTime = this.video.currentTime);
      }
      "function" == typeof requestAnimationFrame &&
        requestAnimationFrame(() => this.transitionToTargetTime());
    }
    setTargetTimePercent(t) {
      (this.targetTime =
